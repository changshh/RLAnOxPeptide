...
if __name__ == "__main__":
    ...
    parser.add_argument("--learning_rate", type=float, default=1e-4, help='See README for details.')
    parser.add_argument("--num_epochs", type=int, default=3, help='See README for details.')
    parser.add_argument("--batch_size", type=int, default=1, help='See README for details.')
    parser.add_argument("--max_length", type=int, default=512, help='See README for details.')

    parser.add_argument("--lora_r", type=int, default=8, help='See README for details.')
    parser.add_argument("--lora_alpha", type=int, default=16, help='See README for details.')
    parser.add_argument("--lora_dropout", type=float, default=0.1, help='See README for details.')
